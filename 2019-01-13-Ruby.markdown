...
* RubyGems
    ...
    * Bundler
        ...
        * Gemfile, Gemfile.lock
            ...
            * ‘$ bundle exec jekyll serve’ 하면 -> Bundler가 Gemfile.lock에 RubyGem을 사용하여 Jekyll 사이트를 생성 -> 호환성, dependency 충돌 발생하지 않음
...
* Gem 사용
    * 일반적으로 오픈소스로 배포되어 있음
    * 찾기, 다운로드: 
        * https://rubygems.org/ 에서 필요한 GEM 검색
            * GEMFILE: [생성한 ruby on rails project에 어떻게 넣을지?]
            * INSTALL: [install 방법, 명령어 나와있음]
            * LINKS:
                * Hompage
                * Source code
                * Documentation
